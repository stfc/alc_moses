...
## output files with the reference output files copied in the reference directory
## #####################################################################################################
...
# # Define the list of output files
   declare -a FileArray=("OUTPUT" \\
                         "SIMULATION_FILES/MODEL_SUMMARY" \\
                         "SIMULATION_FILES/input.cp2k" \\
                         "SIMULATION_FILES/INCAR" \\
                         "SIMULATION_FILES/KPOINTS" \\ 
                         "SIMULATION_FILES/model.param" \\
                         "SIMULATION_FILES/CI-castep.cell" \\
                         "SIMULATION_FILES/CI-onetep.dat" \\
                         "SIMULATION_FILES/hpc_script-vasp.sh" \\
                         "SIMULATION_FILES/hpc_script-cp2k.sh" \\
                         "SIMULATION_FILES/hpc_script-castep.sh"\\
                         "SIMULATION_FILES/hpc_script-onetep.sh" )
